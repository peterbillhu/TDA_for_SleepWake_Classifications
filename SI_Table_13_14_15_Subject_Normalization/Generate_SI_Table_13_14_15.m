...
% Generate Table SI 13 (training on "Training")
expName = 'EXP_Table_SI_13_training_on_Training';
run_ceeds(expName,...
          numOfSeeds,...
          [v120T(:,1:end-1) v90T],...
          [v120V(:,1:end-1) v90V],...
...
% Generate Table SI 14 (training on "Dreams")
expName = 'EXP_Table_SI_14_training_on_Dreams';
...
% Generate Table SI 15 (training on "UCD")
expName = 'EXP_Table_SI_15_training_on_UCD';
