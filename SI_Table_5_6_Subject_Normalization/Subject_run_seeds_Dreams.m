function run_seeds_Dreams(Exp_Name,...                     %% Experiment name
...
for ceed = 1 : numOfCeeds
    resultTra = Subject_getModel_3_classes([Exp_Name, '_Training'],...      %% Name of experiment
                         ceed,...                         %% Input randomCeed for training data sampling
                         [pdfeatDREAMWLabel],...          %% Training data with labels
    ...
    resultVal = Subject_getModel_3_classes([Exp_Name, '_Validation'],...    %% Name of experiment
                         ceed,...                         %% Input randomCeed for training data sampling
                         [pdfeatDREAMWLabel],...          %% Training data with labels
     ...
     resultDreams = Subject_getModel_3_classes([Exp_Name, '_Dreams'],...    %% Name of experiment
                             ceed,...                     %% Input randomCeed for training data sampling
                             [pdfeatDREAMWLabel],...      %% Training data with labels
     ...
     resultUCD = Subject_getModel_3_classes([Exp_Name, '_UCD'],...          %% Name of experiment
                          ceed,...                        %% Input randomCeed for training data sampling
                          [pdfeatDREAMWLabel],...         %% Training data with labels
