...
% Generate SI Table 1 (training on "Dreams")
expName = 'EXP_Table_SI_1_training_on_Dreams';
...
% Generate SI Table 2 (training on "UCD")
expName = 'EXP_Table_SI_2_training_on_UCD';
