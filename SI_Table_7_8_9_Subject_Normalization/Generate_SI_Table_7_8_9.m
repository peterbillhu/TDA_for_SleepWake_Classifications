...
% Generate SI Table 7 (training on "Training")
expName = 'EXP_Table_SI_7_training_on_Training';
run_ceeds(expName,...
                  numOfCeeds,...
                  [v120T(:,1:end-1) v90T],...
                  [v120V(:,1:end-1) v90V],...
...
% Generate SI Table 8 (training on "Dreams")
expName = 'EXP_Table_SI_8_training_on_Dreams';
...
% Generate SI Table 9 (training on "UCD")
expName = 'EXP_Table_SI_9_training_on_UCD';
