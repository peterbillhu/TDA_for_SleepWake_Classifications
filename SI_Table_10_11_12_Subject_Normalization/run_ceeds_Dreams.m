function run_ceeds_Dreams(Exp_Name,...                     %% Experiment name
...
for ceed = 1 : numOfCeeds
    resultTra = getModel([Exp_Name, '_Training'],...      %% Name of experiment
    ...
    resultVal = getModel([Exp_Name, '_Validation'],...    %% Name of experiment
                         ceed,...                         %% Input randomCeed for training data sampling
                         [pdfeatDREAMWLabel],...          %% Training data with labels
     ...
     resultDreams = getModel([Exp_Name, '_Dreams'],...    %% Name of experiment
                             ceed,...                     %% Input randomCeed for training data sampling
                             [pdfeatDREAMWLabel],...      %% Training data with labels
     ...
     resultUCD = getModel([Exp_Name, '_UCD'],...          %% Name of experiment
                          ceed,...                        %% Input randomCeed for training data sampling
                          [pdfeatDREAMWLabel],...         %% Training data with labels
